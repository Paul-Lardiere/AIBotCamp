...
set AIBOOTCAMP2_ENGINE_DIR="C:\Users\Antoine\Documents\DDJV\AIBootCamp2"
set AIBOT_PATH="C:\Users\Antoine\Documents\DDJV\IA\build-solution-x64\Debug\myfirstaibot.dll"
set TEAM=ElTonioBot
